...
func main() {
        ...
        err = client.Call("RPCService.RPCSet", &setReq, &setResp)
        if err != nil {
        ...
        err = client.Call("RPCService.RPCGet", &getReq, &getResp)
        if err != nil {
        ...
        err = client.Call("RPCService.RPCDelete", &deleteReq, &deleteResp)
        if err != nil {
